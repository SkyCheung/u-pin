...
class AopClient {
	...
	protected function sign($data, $signType = "RSA") {
		...
		$res = openssl_get_privatekey($priKey);  //修改php.ini文件 去掉 extension=php_openssl.dll 前面的注释
	...
	//获取签名
	public function get_sign($request)
	{
	...
	*/
	...
	protected function buildRequestForm($para_temp) {
        ...
        $sHtml = $sHtml."<div class='single-all-btn' style='margin:0 10px;'><input type='submit' class='save-orange save-btn fix-btn' value='立即支付' style='top: 400px;position: relative;'></div></form>";
