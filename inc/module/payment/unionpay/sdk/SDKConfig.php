...
// 签名证书路径
define('SDK_SIGN_CERT_PATH', approot.'/inc/module/payment/unionpay/certs/acp_test_sign.pfx');

// 密码加密证书（这条一般用不到的请随便配）
//const SDK_ENCRYPT_CERT_PATH = 'D:/certs/acp_test_enc.cer';
define('SDK_ENCRYPT_CERT_PATH', approot.'/inc/module/payment/unionpay/certs/acp_test_enc.cer');
